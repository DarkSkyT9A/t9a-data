...
function summarizeCategoryPoints(list) {
    list.pointsPerCategory = {};
    // TODO Add category modifier for wildheart and wdg
    list.pointsPerCategory = {
        "Characters": list.units.reduce((a, b) => a + (b.category === "Characters" ? b.cost : 0), 0),
        "Core": list.units.reduce((a, b) => a + (b.category === "Core" ? b.cost : 0), 0),
